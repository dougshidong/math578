function square_solid(ansys_run,ansys_file_name, BC_type,load_case,E,nu,H,L,n)
%clc
format long
...
elem_size=L/n;
    ...
    fprintf(Ansys_file, 'MPDATA,EX,2,,%f\n',E);
    fprintf(Ansys_file, 'MPDATA,PRXY,2,,%f\n',nu);
    ...
    fprintf(Ansys_file, 'ASEL,S,AREA,,3 \n');
    fprintf(Ansys_file, 'AATT,1, ,1,0, \n');
    
    fprintf(Ansys_file, 'ASEL,S,AREA,,2 \n');
    fprintf(Ansys_file, 'AATT,2, ,1,0, \n');
