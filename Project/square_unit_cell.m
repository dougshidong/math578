...
function square_unit_cell(ansys_run,ansys_file_name, BC_type,load_case,E,nu,H,L,t,n)
...
elem_size=L/n;
    ...
    fprintf(Ansys_file, 'K,5,%f,%f,,\n',t,t);
    fprintf(Ansys_file, 'K,6,%f,%f,,\n',L-t,t);
    fprintf(Ansys_file, 'K,7,%f,%f,,\n',L-t,H-t);
    fprintf(Ansys_file, 'K,8,%f,%f,,\n',t,H-t);
    ...
    fprintf(Ansys_file, 'LSTR,       5,       6\n');
    fprintf(Ansys_file, 'LSTR,       6,       7\n');
    fprintf(Ansys_file, 'LSTR,       7,       8\n');
    fprintf(Ansys_file, 'LSTR,       8,       5\n');

    fprintf(Ansys_file, 'AL,1,2,3,4,5,6,7,8\n');
    fprintf(Ansys_file, 'AESIZE, 1, %f,  \n',elem_size);
