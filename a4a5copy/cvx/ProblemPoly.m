...
u = linspace(-1,1,m);
v = 1./(5+40*u.^2) + 0.1*u.^3 + 0.01*randn(1,m); disp('expect reasonable fit')

% Can change the noise:
%v = 1./(5+40*u.^2) + 0.1*u.^3 + 0.1*randn(1,m); disp('bad model')
...
% L-infty fit
fprintf(1,'Computing optimal polynomial in the case of LP-norm...');
